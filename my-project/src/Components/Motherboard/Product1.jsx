...
const Product1 = () => {
  ...
  const handleAddToCart = async (product) => {
    try {
      ...
      const data = {
        productId: product._id, // Use the individual product's _id
        userId,
        quantity: count,
        name: product.name, // Use the individual product's name
        price: product.price, // Use the individual product's price
        imageLink: product.imagelink, // Use the individual product's image link
      };
  ...
  const filteredProducts = products.filter((product) => product.category === "motherboard");
        ...
        {filteredProducts.map((product) => (
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 bg-black/60 border-t border-gray-900">
                ...
                <button
                  onClick={() => handleAddToCart(product)} // Pass the current product to handleAddToCart
